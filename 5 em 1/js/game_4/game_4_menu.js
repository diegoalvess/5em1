function SceneMenu()
{
    ...
    this.efeito_sonoro.src = "sounds/game_4/Menu.mp3"
    this.efeito_sonoro.load();
    
    //imagem dos botões
    this.botao_comecar = new Button("imgs/game_4/botaocomecar.png", 302, 85, 580, 300);
    this.botao_creditos = new Button("imgs/game_4/botaocredito.png", 302, 85, 630, 480);
